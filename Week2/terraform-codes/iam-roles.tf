...
resource "aws_iam_role" "jaewlim-iam-role-ec2-instance-bastion" {
...
POLICY
  name                 = "jaewlim-iam-role-ec2-instance-bastion"
...
resource "aws_iam_role" "jaewlim-eks_iam_cluster" {
  name = "jaewlim-EKS-IAM-CLUSTER"
...
resource "aws_iam_role_policy_attachment" "jaewlim-eks_iam_cluster_AmazonEKSClusterPolicy" {
  role = aws_iam_role.jaewlim-eks_iam_cluster.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
}

// EKS Worker Node IAM Role - EC2 인스턴스가 사용자를 대신하여 AWS 서비스를 호출하도록 허용
resource "aws_iam_role" "jaewlim-eks_iam_nodes" {
  name = "jaewlim-EKS-IAM-WORKERNODE"
...
resource "aws_iam_role_policy_attachment" "jaewlim-eks_iam_cluster_AmazonEKSWorkerNodePolicy" {
  role = aws_iam_role.jaewlim-eks_iam_nodes.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSWorkerNodePolicy"
}

// - Amazon EC2 Container Registry 리포지토리에 대한 읽기 전용 액세스를 제공
resource "aws_iam_role_policy_attachment" "jaewlim-eks_iam_cluster_AmazonEC2ContainerRegistryReadOnly" {
  role = aws_iam_role.jaewlim-eks_iam_nodes.name
...
resource "aws_iam_role_policy_attachment" "jaewlim-eks_iam_cluster_AmazonEKS_CNI_Policy" {
  role = aws_iam_role.jaewlim-eks_iam_nodes.name
